...
public class ApiClient {
    ...
    private String basePath = "http://localhost/apidocs/api/pal/servlet/Payment/v18";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost/apidocs/api/pal/servlet/Payment/v18
