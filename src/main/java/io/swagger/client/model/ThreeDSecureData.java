...
public class ThreeDSecureData {
  ...
  **/
  @ApiModelProperty(value = "the enrollment response from the 3D directory server")
  ...
  **/
  @ApiModelProperty(value = "the authentication response if the shopper was redirected")
   ...
   * @return xid
  **/
  @ApiModelProperty(value = "the transaction identifier (base64 encoded, 20 bytes in decoded form)")
   ...
   * @return cavv
  **/
  @ApiModelProperty(value = "the cardholder authentication value (base64 encoded, 20 bytes in decoded form)")
