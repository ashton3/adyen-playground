...
public class Recurring {
   ...
   * @return contract
  **/
  @ApiModelProperty(value = "how the recurring detail will be used, multiple values allowed as comma separated")
  ...
  **/
  @ApiModelProperty(value = "assign a descriptive name for this detail")
